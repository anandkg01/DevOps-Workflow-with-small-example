...
# install a war gameoflife.war. The file gameoflife.war is located in 
...
tomcat::war { 'gameoflife.war':
               catalina_base => '/opt/tomcat',
               war_source => 'puppet:///modules/tomcat/gameoflife.war',
            }
